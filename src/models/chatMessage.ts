export interface ChatMessage {
    ...
    id: number;
    // Имя отправителя, показывает в UI
    author: string;
    // Текст сообщения
    text: string;
    // Метка времени (UTC, миллисекунды)б чтобы выводить человеческое время на клиенте
    timestamp: number;
}

// Простейшая модель с хранением сообщений в памяти процесса
export class ChatModel {
    // Хранилище сообщений; на серверележит только в RAM
